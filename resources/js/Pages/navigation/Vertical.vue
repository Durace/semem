                ...
                <ul id="sidebarnav" class="pt-4">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">FACTURATION
                            </span></a>
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <Link href="facturation-proformat" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
                                        class="hide-menu">
                                        PROFORMA
                                    </span></Link>
                            </li>
                            ...
                            <li class="sidebar-item">
                                <Link href="facturation-stock" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                        class="hide-menu">
                                        Stock
                                    </span></Link>
                            </li>
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            ...
                            <li class="sidebar-item">
                                <a href="pages-chat.html" class="sidebar-link"><i
                                        class="mdi mdi-message-outline"></i><span class="hide-menu">
                                        Chat Option
                                    </span></a>
                            </li>
                        </ul>
